<!-- FOOTER START -->
<footer class="site-footer footer-dark bg-no-repeat bg-full-height bg-center " style="background-image:url(assets/images/background/footer-bg.jpg);">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="widget widget_about">
                        ...
                        <div class="logo-footer clearfix p-b15 text-center">
                            ...
                            <img src="{{ asset('assets/images/logo-light.jpg')}}" style="height:80px;width:100%;"  alt="">
                            </a>
                        </div>
                        <p>OPEC Trade was established in 2013 and it initially began trading stocks, shares and bonds, it got involved in forex in 2015 and was among the pioneer traders of Cryptocurrencies in the advent of Bitcoin in 2014. OPEC Trades is currently...
                        </p>
                    </div>
                </div>
                <!-- RESENT POST -->
                ...
                <div class="col-md-3 col-sm-6 p-tb20">
                    <div class="wt-icon-box-wraper left  bdr-1 bdr-gray-dark p-tb15 p-lr10 clearfix">
                        ...
                        <div class="icon-content text-white">
                            ...
                            <p class="m-b0">support@opectrade.org</p>
        ...
        <div class="container p-t30">
            <div class="row">
                <div class="wt-footer-bot-left">
                    <span class="copyrights-text">&copy; <?=date('Y')?> Your Company. All Rights Reserved. Designed By TheStephens.</span>
                </div>
